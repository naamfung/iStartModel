...
Qwen3.6-35B-A3B-Uncensored-Genesis APEX 版：
https://huggingface.co/LuffyTheFox/Qwen3.6-35B-A3B-Uncensored-Genesis-Hermes-V7-GGUF/tree/main
...
本人批注：我现在的主力模型系「mudler/Qwen-AgentWorld-35B-A3B-APEX」，使用Qwen-Agentic-EN / Qwen-Agentic-HON(S/T) 模板，LlamaCpp引擎目前使用我自己维护的[稳定分支](https://github.com/naamfung/laamaafung)。建议用于智能代理、编程场景。

APEX 比 UD 量化快好兮多，经验证「mudler/Qwen-AgentWorld-35B-A3B-APEX」稳定且可长期使用，若果感觉不好建议回退到 UD 量化。
...
对于混合专家模型而言，思考过程为必须品，因为思考过程会将所有可能性预先触达一次，以便加载到键值缓存中，而键值缓存中是否存在相关上下文数据就是下阶段生成时的燃料。
